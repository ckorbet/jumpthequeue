...
public interface NlsBundleApplicationRoot extends NlsBundle {
  ...
  /**
   * @see com.cap.jumpthequeue.general.common.api.exception.IllegalEntityStateException
   *
  ...
  /**
   * @see com.cap.jumpthequeue.general.common.api.exception.NoActiveUserException
   *
   * @return the {@link NlsMessage}.
   */
